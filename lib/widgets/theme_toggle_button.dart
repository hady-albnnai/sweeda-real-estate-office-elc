...
class ThemeToggleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final label = theme.isDarkMode ? 'تفعيل الوضع النهاري' : 'تفعيل الوضع الليلي';

    // هذا الزر موجود خارج Overlay/Navigator لأنه موضوع في MaterialApp.builder.
    // لذلك لا نستخدم Tooltip هنا حتى لا يظهر خطأ: No Overlay widget found.
    return SafeArea(
      child: Align(
