...
| P5 | إحصائيات ودوال مجمعة | تقليل تحميل القوائم الكبيرة | قيد التنفيذ: RPC إحصائيات الإدارة جاهزة |
...
- [x] نقل عدّ إحصائيات الإدارة للسيرفر عبر `get_admin_dashboard_stats`.
