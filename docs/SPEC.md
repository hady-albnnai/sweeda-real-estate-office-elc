...
## ✅ كل النقاط المعتمدة (1-11)

- [x] النقطة 1: الزائر
- [x] النقطة 2: المستخدم والتفعيل (OTP)
- [x] النقطة 3: الهيكل العام للواجهة
- [x] النقطة 4: تبويب العروض
- [x] النقطة 5: تبويب الطلبات
- [x] النقطة 6: رفع العرض والمراجعة
- [x] النقطة 7: حجز المواعيد
- [x] النقطة 8: موافقة الوسيط وصاحب العرض
- [x] النقطة 9: الوسيط ولوحته
- [x] النقطة 10: لوحة الإدارة والصلاحيات
- [x] النقطة 11: الإشعارات (داخلية + FCM)
- [ ] النقطة 12: نموذج البيانات (Firestore) → **موجودة أعلاه، تحتاج تأكيد**

---

## 📁 ملف locations.json

✅ موجود في `docs/locations.json` — يحتاج مراجعة نهائية من صاحب المشروع.
