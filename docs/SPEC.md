...
## تحديث 2026-06-13 — شاشة إضافة عرض احترافية

### حقول العقار
| الحقل | المصدر | إلزامي |
|---|---|---|
| المنطقة الرئيسية | Config `locs` + إدخال حر | ✅ |
| وصف الموقع | حقل نص | ✅ |
| المساحة (م²) | حقل رقم | ❌ |
| الإكساء | قائمة (5 خيارات) | ❌ |
| الطابق | حقل رقم | ❌ |
| الاتجاه | قائمة (8 اتجاهات) | ❌ |
| ملاحظات قانونية | حقل نص | ❌ |
| الخريطة | LocationPicker | ❌ |
| المواعيد المتاحة (avl) | فترات يوم/ساعة | ❌ |

### حقول السيارة
| الحقل | المصدر | إلزامي |
|---|---|---|
| لوحة السيارة | حقل نص | ✅ |
| المحافظة | قائمة (14 محافظة) | ❌ |
| الماركة | حقل نص | ✅ |
| الموديل | حقل نص | ✅ |
| سنة الصنع | حقل رقم | ✅ |
| اللون | حقل نص | ❌ |
| الكيلومترات | حقل رقم | ❌ |
| نوع الوقود | قائمة (5 خيارات) | ❌ |
| ناقل الحركة | قائمة (3 خيارات) | ❌ |
| سند ملكية السيارة | Config `carDocTp` | ✅ (بـ step4) |
| نوع النمرة | Config `plateTp` | ✅ (بـ step4) |

### Config الجديد
| المفتاح | المحتوى |
|---|---|
| `locs` | `["السويداء","صلخد","شهبا"]` |
| `carDocTp` | `{"0":"مواصلات نظامي","1":"حكم محكمة","2":"وارد مع تسلسل ملكية حصراً"}` |
| `plateTp` | `{"0":"نمرة قديمة","1":"نمرة جديدة","2":"وارد مع تسلسل ملكية حصراً"}` |

### عمود جديد: `offers.offer_number`
- عداد تسلسلي (sequence `offer_number_seq`)
- يُعبّأ تلقائياً عند الإنشاء عبر trigger `trg_set_offer_number`
- يظهر للجمهور بالبطاقة (#N) وبتفاصيل العرض
