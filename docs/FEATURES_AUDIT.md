...
> **تاريخ التدقيق:** 2026-06-05 (محدث 2026-06-08: إصلاح نقاط تسجيل الدخول + توقيت سوريا + تخفيض إلى 50 + guard ضد التكرار)
...
**المواصفات:** `pts.wkL=50` — مكافأة للمستخدم النشط أسبوعياً (تم تخفيضها من 500).
