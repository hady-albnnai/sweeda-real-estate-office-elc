...
## تحديث 2026-07-05 — زر تبديل الوضع النهاري/الليلي عام لكل الأدوار

- تمت إضافة `ThemeProvider` لحفظ اختيار المظهر في `SharedPreferences`.
- تمت إضافة زر عائم عام يظهر فوق كل الشاشات لكل الأدوار لتبديل الوضع:
  - نهاري أبيض/ذهبي.
  - ليلي أسود/ذهبي.
- تم ربط `AppTheme` بحالة المظهر لتغيير الخلفيات والبطاقات والنصوص ديناميكياً.
- تم إجبار إعادة بناء الشجرة عند التبديل حتى تتحدث الشاشات الحالية مباشرة.
