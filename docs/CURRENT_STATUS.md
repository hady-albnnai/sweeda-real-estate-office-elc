...
تمت إضافة طبقة تحقق أولية للمدخلات في Flutter وSQL. تشمل helpers للسيرفر وتحديث RPCs مهمة مثل إنشاء العرض والطلب وتحديث الملف الشخصي وإنشاء الموظف. الحالة: جاهزة للتطبيق على السيرفر — لم تكن مطبقة حسب آخر فحص، وتم تصحيح ملف migration قبل التطبيق.
