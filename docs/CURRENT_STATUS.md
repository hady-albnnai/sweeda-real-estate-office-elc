...
**آخر تحديث:** 2026-07-28 — ✅ إقفال فجوتي إشعارات المواعيد والمشرف + إصلاح تظهير الدفعات
**الفرع:** `main` (commit `b587168`)
**الحالة العامة:** ✅ **جاهز للإطلاق** — 180 دالة (167 محصّنة SECURITY DEFINER)، 35 Edge Function، كل المسارات الجوهرية مُثبتة حياً.
