...
| المجال | الحالة |
|---|---|
| شاشة إضافة العرض بكل الأدوار (2026-07-26) | تدقيق شامل وإصلاح 6 مشاكل: أزرار التالي/رجوع كانت مفقودة بشاشة المستخدم (سبب "التوقف بعد الأساسيات")، قراءة آمنة للإعدادات بدل int.parse، حماية RangeError عند تبديل النوع، watch بدل read للتصنيفات، seed رسمي لـ catVeh/carDocTp/plateTp بـ setup.sql (كانت سبب عرض تصنيفات العقارات للسيارات — تحتاج تصحيح SQL يدوي بالسيرفر الحي)، مدخل "إضافة عرض" للمدير/النائب بقائمة الأقسام، توحيد بوابة الصلاحية add_offer_admin — التفاصيل: `docs/ADD_OFFER_SCREEN_AUDIT_2026-07-26.md` |
