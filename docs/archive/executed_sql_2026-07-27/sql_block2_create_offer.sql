-- ╔══════════════════════════════════════════════╗
-- ║ كتلة 2 — create_offer_internal (سقف العروض مع التراكم)
-- ║ شغّلها كاملة في SQL Editor بعد كتلة 1
-- ╚══════════════════════════════════════════════╝
...
-- تحصين — service_role فقط (تنادى عبر user-offers / admin-offers بالمفتاح)
