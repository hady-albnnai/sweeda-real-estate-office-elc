-- ════════════════════════════════════════════════════════════════════════════
-- Add media_review to internal permissions allowed keys
-- Date: 2026-06-10
-- Note: This migration is needed if admin_update_user_permissions was already
--       created before the media review screen was added.
-- ════════════════════════════════════════════════════════════════════════════
